...
/**
 * Manages "Authentication" to Rubric's backend service.  The SyncAdapter framework
 ...
 */
public class RubricAuthenticator extends AbstractAccountAuthenticator {

    public RubricAuthenticator(Context context) {
        super(context);
    }
